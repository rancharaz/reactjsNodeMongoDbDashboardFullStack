            ...
            <div className="mx-auto container text-center justify-center items-center flex">
                ...
                {/* show only signup and login when user not login */}
                {
                    auth ? <ul className='text-white p-3.5 '>
                        ...
                        <Link onClick={logout} to="/sign-up" className='pr-4 hover:text-gray-500 transition-all' >Logout - <span className='text-lg text-gray-500 font-bold'>Username: {JSON.parse(auth).name}</span> </Link>
